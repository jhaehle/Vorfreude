...
SWIFT_MODULE_NAMESPACE_PUSH("Gifu")
@class CALayer;
@class UIImage;
@class NSCoder;
...
- (UIImage * _Nonnull)resizedTo:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A new resized image instance.
- (UIImage * _Nonnull)constrainedBy:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
...
/// returns:
/// A new resized image instance.
- (UIImage * _Nonnull)fillingWithSize:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
/// Returns a new <code>UIImage</code> instance using raw image data and a size.
...
///
/// returns:
/// A new image instance from the passed in data.
+ (UIImage * _Nullable)imageWith:(NSData * _Nonnull)data size:(CGSize)size SWIFT_WARN_UNUSED_RESULT;
@end
